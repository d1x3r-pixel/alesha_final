...
TRIGGERS = {'алёша', 'алёшка', 'алеша', 'алоша', 'лоша', 'але', 'алё', 'леша', 'лёша'}
...
'расскажи анекдот':'pas_anekdots без б',
...
# 'леща':'passive Слушаю',
# 'алеша':'passive Слушаю',
# 'алёша':'passive Слушаю',
# 'лёша':'passive Слушаю',
# 'лоша':'passive Слушаю',
# 'олежка':'passive Слушаю',
# 'алешка':'passive Слушаю',
'поиск':'search Говорите',
'найди в брузере':'search без проблем говорите что найти',
'включи музыку':'spotify конечно',
'музыка':'spotify потанцуем?',
'запиши задачу':'bloknot',
'запиши в блокнот':'bloknot',
'задачу напишы':'bloknot',
